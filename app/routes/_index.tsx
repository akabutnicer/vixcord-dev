...
function Title({ title, halfway = false }) {
  ...
  return (
    <div class="absolute left-20 top-5">
      <h1 class="text-4xl font-extrabold">{halfway ? halfwayText : title}</h1>
    </div>
  );
}
  ...
  return (
    <>
      ...
      {show && (
        <>
              <button
          class="invisible text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          type="button"
