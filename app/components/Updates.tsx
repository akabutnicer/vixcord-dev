                    ...
                    <ol class="relative border-s border-gray-200 dark:border-gray-600 ms-3.5 mb-4 md:mb-5">                 
                      {updates.map(update => (
                        <li class="mb-10 ms-8">            
                            ...
                            <time class="block text-sm font-normal leading-none text-gray-500 dark:text-gray-400">Released on {update.date}</time>
                            <h3 class="flex items-start mb-1 text-lg font-semibold text-gray-900 dark:text-white">{update.content.title} {update.latest && <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">Latest</span>}</h3>
                            <time class="block mb-3 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">Released on {update.date}</time>
